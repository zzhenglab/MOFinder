...
class ScreeningTests(unittest.TestCase):
    def setUp(self):
        ...
        self.config.update(project_root=str(ROOT), input_file='Demo/03_abstract_triage/metadata.csv',
                           ground_truth_file='Demo/03_abstract_triage/ground_truth.csv',
    ...
    def test_config_paths_are_relative_to_configured_project_root(self):
        ...
        self.assertEqual(loaded['input_file'], ROOT / 'Demo/03_abstract_triage/metadata.csv')
