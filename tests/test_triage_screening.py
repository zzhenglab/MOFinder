...
class ScreeningTests(unittest.TestCase):
    def setUp(self):
        ...
        self.config.update(project_root=str(ROOT), input_file='Demo/03_api_demo/inputs/triage_metadata.csv',
                           ground_truth_file='Demo/03_api_demo/inputs/triage_ground_truth.csv',
    ...
    def test_config_paths_are_relative_to_configured_project_root(self):
        ...
        self.assertEqual(loaded['input_file'], ROOT / 'Demo/03_api_demo/inputs/triage_metadata.csv')
