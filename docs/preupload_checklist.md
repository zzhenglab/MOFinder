...
| --- | --- | --- | ---: |
| Archived | `data/processed/revised/positive_stage6.csv` and `data/processed/revised/negative_stage6_v3.csv` | `results/datasets/archived_conditions/` | 23,528 / 2,595 |
| Corrected linker spellings | Same positive table and `data/processed/corrected/negative_stage6_v3.csv` | `results/datasets/corrected_conditions/` | 23,436 / 2,604 |
...
| Cleaning lookups | `data/lookups/linker_molecular_weights.csv`; `data/lookups/linker_prime_corrections.json` | Included. MW CSV has no header. Leave unresolved weights blank until established. |
