# Abstract triage and synthesis extraction
...
Start with [mof_triage_extraction_demo.ipynb](mof_triage_extraction_demo.ipynb). It displays four complete abstracts,
...
evidence. The corresponding terminal commands use [mof_triage_extraction_demo.py](mof_triage_extraction_demo.py).
...
python Demo/03_triage_extraction/mof_triage_extraction_demo.py
jupyter lab Demo/03_triage_extraction/mof_triage_extraction_demo.ipynb
```
...
Commands also work from this folder using `python mof_triage_extraction_demo.py`, or from another
...
To check only the triage inputs, run `python Demo/03_triage_extraction/mof_triage_extraction_demo.py triage`.
...
python Demo/03_triage_extraction/mof_triage_extraction_demo.py positive --live
python Demo/03_triage_extraction/mof_triage_extraction_demo.py negative --live
```
...
| --- | --- | --- |
| Abstract triage | Four abstracts selected from the 12-paper subset in `inputs/` | GPT-4o; one round; one request at a time |
...
article/SI pair under `Demo/03_triage_extraction/inputs/extraction/` remains available for the default demonstration.
...
`results/examples/03_triage_extraction/local_papers/`.
...
`results/examples/03_triage_extraction/`, which is excluded from Git:
