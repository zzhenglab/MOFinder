...
The [article and supporting-information tables](literature_retrieval/README.md)
include rough keyword-based classifications in their `Classification` column
to help examine trends alongside the study's LLM-based triage.
