"""Apply the cls-A classifier to the training subset B (so we can mine the
misclassifications of A as a new "hard" set H — see extract_misclassified_h.py).
"""
...
HOLDOUT_PATH = REPO_ROOT / "data" / "mof_cls_train.jsonl"
